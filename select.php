<?php  
 ...
 $output = '';  
 $sql = "SELECT * FROM comity_data ORDER BY id DESC";  
 ...
 {  
	  if($rows > 10)
	  {
		  ...
		  $delete_sql = "DELETE FROM comity_data LIMIT $delete_records";
      ...
      {  
           $output .= '  
                <tr>  
                     ...
                     <td class="c_name" data-id2="'.$row["id"].'" contenteditable>'.$row["c_name"].'</td>  
